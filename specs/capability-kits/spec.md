...
- The mutation-testing kit must keep its Stryker runner, checker, reporting, and workflow shape aligned with `stryker.config.mjs`; target-specific source exclusions, concurrency, and score thresholds remain adaptable rather than inheriting this project's measured debt floor.
