...
- The validated library contains twenty-eight schema-version-1, revision-1 exercises:
...
- Twenty studies contain five expected-event occurrences; the 5/4 pulse pair contains six; the 3/4 broken-chord pair contains seven; and the mixed-pattern and steady broken-chord pairs each contain eight. The first twelve exercises and the offbeat pair contain five distinct pitches; the four ordered chord-tone studies plus the repeated-note, steady broken-chord, and 3/4 broken-chord pairs each contain three distinct pitches; the 5/4 pair returns to its first C across six event IDs and five distinct C-position pitches; and the mixed pair returns to five distinct C-position pitches across eight event IDs. Ten studies use `untimed-ordered-notes`; eighteen use `timed-ordered-notes`.
...
- Each ordered chord-tone study uses three distinct pitches across five event IDs. The C-major pair reuses C and E controls over C-D-E-F-G; the D-minor pair reuses D and F controls over D-E-F-G-A. Event progress, semantic note order, and staff markers remain occurrence-based.
...
- [ ] Twenty-six stable exercises cover thirteen studies per hand, ascending and descending motion, untimed and timed step-skip coordination, ordered C-major chord tones, straight steady quarter notes, steady broken-chord patterns, 3/4 broken-chord loops, 5/4 pulse patterns, even-eighth onset subdivision, adjacent repeated-note onsets, one longer mixed pattern, and offbeat-onset preparation while preserving the original right-hand ascent as default.
- [ ] Eighteen exercises contain five expected-event occurrences; the 5/4 pair contains six; the 3/4 pair contains seven; and the mixed-pattern and steady broken-chord pairs contain eight. Eight exercises are untimed and exactly eighteen use the timed evaluator.
...
- Given: twenty-eight schema-version-1 documents for the current exercises
- When: the exercise library validates them
- Then: it exposes twenty-eight unique stable IDs, five occurrences for twenty studies, six for each 5/4 pulse study, seven for each 3/4 broken-chord study, eight for each mixed-pattern and steady broken-chord study, ten untimed and eighteen timed studies, lawful original-source metadata, and the original right-hand ascent as default
