...
- The validated library contains twenty-four schema-version-1, revision-1 exercises:
...
- Eighteen studies contain five expected-event occurrences; the 3/4 broken-chord pair contains seven; and the mixed-pattern and steady broken-chord pairs each contain eight. The first twelve exercises and the offbeat pair contain five distinct pitches; the ordered chord-tone, repeated-note, steady broken-chord, and 3/4 broken-chord studies each contain three distinct pitches, while the mixed pair returns to five distinct C-position pitches across eight event IDs. Eight studies use `untimed-ordered-notes`; the eight steady-quarter, two ascending even-eighth, two repeated-note, two mixed-pattern, and two offbeat studies use `timed-ordered-notes`.
...
- All sixteen timed studies share a 40–100 BPM range with 60 BPM default and a quarter-note beat unit and click. Fourteen retain 4/4 meter with a four-beat count-in; the 3/4 pair declares three beats per measure and a three-beat count-in.
...
- [ ] Twenty-four stable exercises cover twelve studies per hand, ascending and descending motion, untimed and timed step-skip coordination, ordered C-major chord tones, straight steady quarter notes, steady broken-chord patterns, 3/4 broken-chord loops, even-eighth onset subdivision, adjacent repeated-note onsets, one longer mixed pattern, and offbeat-onset preparation while preserving the original right-hand ascent as default.
- [ ] Eighteen exercises contain five expected-event occurrences; the 3/4 pair contains seven; and the mixed-pattern and steady broken-chord pairs contain eight. Eight exercises are untimed and exactly sixteen use the timed evaluator.
...
- [ ] The four five-event steady-quarter studies define beat offsets 0–4, the two eight-event steady broken-chord studies define offsets 0–7, and the two seven-event 3/4 studies define offsets 0–6; all eight use ±0.2-beat tolerance. The two ascending even-eighth and two repeated-note studies define five regular half-beat offsets through beat 2, the two mixed-pattern studies define eight regular half-beat offsets through beat 3.5, and the offbeat pair defines 0, 0.5, 1.5, 2.5, and 3.5. All eight fractional-position studies use ±0.1 beat, and all sixteen timed studies use 40–100 BPM with 60 BPM default and a quarter-note pulse. Fourteen retain 4/4 with a four-beat count-in; the 3/4 pair uses a three-beat count-in.
...
- **Library tests:** Protect stable identities, default selection, canonical order, valid prerequisite references, and acyclic prerequisites; validate all source metadata and per-exercise event counts, and prove left-hand, descending, untimed step-skip, ordered chord-tone, straight steady-quarter, timed step-and-skip, even-eighth, repeated-note, eight-event mixed-pattern, offbeat-step-skip, eight-event steady broken-chord, and seven-event 3/4 broken-chord coverage.
- **Consumer contract tests:** Rendered guidance and evaluator expectations are derived from the same fixture and identity.
- **Rhythm presentation tests:** Unit-beat offsets, regular half-beat offsets, downbeat-then-offbeat offsets, and an otherwise valid timed pattern receive their documented steady-quarter, even-eighth, offbeat, and neutral fallback labels; the 3/4 unit-beat pattern receives its complete pitch-free three-beat count from timing metadata.
...
- Given: twenty-four schema-version-1 documents for the current exercises
- When: the exercise library validates them
- Then: it exposes twenty-four unique stable IDs, five occurrences for eighteen studies, seven for each 3/4 broken-chord study, eight for each mixed-pattern and steady broken-chord study, eight untimed and sixteen timed studies, lawful original-source metadata, and the original right-hand ascent as default
