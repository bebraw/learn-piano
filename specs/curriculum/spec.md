...
The current treble subset through C4-G4 and bass subset through C3-G3 cover the staff positions used by all sixteen current exercises; the repeated-note pair uses only C through E inside those ranges. They connect visible staff position, note name, and keyboard geography. A learner may temporarily hide several visible answers with reading focus, but can reveal them at any time, receives explicit pitch correction after an error, and retains accessible semantic equivalents; completion therefore remains neither a sight-reading test nor reading evidence. Repeated markers in the ordered chord-tone and repeated-note pairs remain occurrence-based and add neither chord nor articulation notation. The guide has no duration semantics and does not establish general clef fluency, interval reading, rhythmic-notation reading, or staff-reading mastery.
...
The eight current timed studies offer hands-separate C-D-E-F-G, C-E-D-F-G, or C-C-D-D-E in 4/4 with a four-beat count-in, quarter-note click, and selectable 40–100 BPM tempo. Their first accepted correct note anchors timing; four later correct-note MIDI timestamp deltas provide internal `on-pulse`, early, or late evidence against canonical beat gaps, presented to the learner as on time, early, or late. The timed step-and-skip pair names both the matching untimed step-and-skip and straight steady-quarter studies as advisory prerequisites. The ascending even-eighth pair requires only the matching straight steady-quarter completion; the repeated-note pair requires only the matching ascending even-eighth completion. Both half-beat pairs place their “and” onsets between numbered-beat clicks with a proportional ±0.1-beat window. Pitch errors do not move the anchor, and Web Audio guides rather than scores. Completion supports only the declared short steady-quarter, even-eighth, or repeated-note-onset competency, not release, duration, articulation, velocity, rests, syncopation, hands together, adaptive tempo, written-rhythm reading, or general rhythm mastery.
...
- An even-eighth or repeated-note result can support only its declared hands-separate half-beat onset competency at the selected tempo. Repeated-note metadata may additionally identify the practiced adjacent-pitch pattern, but fractional offsets and note-ons do not support release, duration, articulation, rest, written notation, syncopation, simultaneity, hands-together, adaptive-tempo, or physical-technique competencies.
...
- [ ] The sixteen current exercises are mapped only to keyboard-geography, interval, hands-separate guidance, pattern, ordered chord-tone, steady-quarter, even-eighth, and repeated-note onset competencies they actually exercise, without claiming the evaluator verifies hand use or physical technique.
...
- [ ] The two straight steady-quarter studies require their matching untimed ascents, while each timed step-and-skip study requires its matching untimed step-and-skip and straight steady-quarter studies; all four contribute bounded 4/4 quarter-pulse evidence at the selected 40–100 BPM tempo. Each ascending even-eighth study requires only its matching straight steady-quarter study, and each repeated-note study requires only its matching ascending even-eighth study; all four contribute bounded half-beat onset evidence with a ±0.1-beat window.
...
- The eight timed studies must not confer verified hand use, key release, note duration, articulation, velocity, rests, written-notation reading, syncopation, hands-together coordination, adaptive tempo, or broad rhythm or technique mastery. Only the four half-beat studies may support their declared onset-subdivision competencies, and the repeated-note pair adds only adjacent repeated-onset pattern evidence.
...
- **Current documentation checks:** Review the track vocabulary, sixteen-exercise mappings, ordered chord-tone, repeated-note, pitch-guide, and transient reading-focus exposure boundaries, steady-quarter and half-beat onset evidence boundaries, Hanon position, repertoire competency pathways, and explicit current exclusions.
...
- **Behavior tests:** Prove that untimed completion updates only supported pitch/pattern competencies, timed completion adds only its bounded steady-quarter, even-eighth, or repeated-note onset evidence, timed step-and-skip eligibility requires both declared prerequisites, ascending even-eighth eligibility requires the matching steady-quarter completion, repeated-note eligibility requires the matching ascending even-eighth completion, recommendation ignores performance-quality fields, and missing or evicted history and invalid graphs have a neutral fallback.
