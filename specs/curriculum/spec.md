...
- **Current documentation checks:** Review the track vocabulary, twenty-six-exercise mappings, ordered chord-tone, repeated-note, mixed-pattern, offbeat-onset, steady broken-chord, 3/4 broken-chord loop, 5/4 pulse, pitch-guide, and transient reading-focus exposure boundaries, steady-pulse and fractional-onset evidence boundaries, Hanon position, repertoire competency pathways, and explicit current exclusions.
