...
- Completing a 5/4 pulse study proves only six accepted pitches in order and five MIDI-relative whole-beat gaps from the first accepted note. It must not be described as proof of audible 5/4 meter, five-beat count-in, phase, downbeat, click or measure alignment, pulse, counting or grouping, beat-1 accent or dynamics, duration, release, legato, rests, fingering, declared-hand use, relaxation, keyboard geography, five-finger technique, staff reading, consistency, or mastery.
...
- [ ] Timed mode accepts 40–100 BPM for all eighteen current studies, defaults to 60 BPM, and assesses each post-anchor interval against canonical beat gaps. The ten five-event timed studies assess four intervals, the 5/4 pair assesses five, the 3/4 pair assesses six, and the mixed-pattern and steady broken-chord pairs each assess seven. The ten steady-quarter studies use inclusive ±0.2-beat tolerance, with the 5/4 pair extending integer offsets through beat 5, the 3/4 pair through beat 6, and the steady broken-chord pair through beat 7; the ascending even-eighth and repeated-note studies use inclusive ±0.1-beat tolerance at offsets 0, 0.5, 1, 1.5, and 2; the mixed-pattern pair extends the regular half-beat grid through beat 3.5; and the offbeat pair uses offsets 0, 0.5, 1.5, 2.5, and 3.5 with the same ±0.1-beat tolerance.
...
- The 5/4 pair's timing must remain MIDI-relative and must never be presented as proof that its first C aligned with audible beat 1 or the five-beat count-in, its later events followed audible clicks or five-beat groups, the learner performed a steady pulse or counted 5/4, or any onset carried a performed accent.
...
**Scenario: Evaluate a 5/4 pulse pattern**

- Given: `five-four-pulse-c-major-right-hand` expects C4-D4-E4-F4-G4-C4 at beat offsets 0–5
- When: those six pitches are accepted at one-second intervals after the first C4 anchors a 60 BPM attempt
- Then: all six occurrences are accepted, all five assessed intervals are on time within the ±0.2-beat window, and completion claims only ordered-pitch and MIDI-relative whole-beat-gap evidence

**Scenario: Keep 5/4 guidance outside evaluation**

- Given: two 5/4-pulse fixtures have identical MIDI timestamp gaps but different first-note timestamps relative to the five-beat count-in, five-beat pulse wrap, and accented beat-1 click
- When: both are evaluated with the same exercise revision and tempo
- Then: their five timing classifications are identical, and neither result claims audible 5/4 meter, count-in, phase, downbeat, click or measure alignment, pulse, counting or grouping, learner accent or dynamics, duration, release, legato, rests, fingering, hand use, relaxation, keyboard geography, five-finger technique, staff reading, consistency, or mastery
