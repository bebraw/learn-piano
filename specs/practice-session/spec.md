...
- [ ] `/practice` returns the canonical default, and `?exercise=<id>` selects each of the twenty-six validated exercises without requiring client JavaScript.
...
- Then: the default C-D-E-F-G right-hand instructions, expected notes, and twenty-six-exercise chooser remain visible, and history says JavaScript is required instead of claiming the history is empty
...
- Then: the left-hand C3-D3-E3-F3-G3 exercise is selected and fully readable with a bass pitch guide, ordered note text, and links to the other twenty-five exercises
