...
- **Folio filter boundary:** The independent home-folio enhancement may temporarily hide unmatched cards by curriculum focus, hand, and untimed or pulse-guided timing. It does not change overview totals, badges, recommendation evidence, canonical order, or storage, and remains available when overview history cannot be read.
