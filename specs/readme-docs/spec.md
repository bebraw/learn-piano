...
- Do not describe the immediate repeat cue as a saved fact, multi-attempt trend, diagnosis, adaptive-tempo decision, mastery judgement, or quality-sensitive study recommendation.
...
- [ ] It describes all thirty-three right- and left-hand exercises, including the thirty original foundations, the Beethoven, Bach, and Pachelbel public-domain arrangements, the C-major and D-minor ordered chord-tone, D-minor five-note ascent, steady broken-chord, 3/4 broken-chord, 5/4 pulse, repeated-note, mixed-pattern, and offbeat pairs, the two straight and two step-and-skip steady-quarter studies, and the ascending even-eighth pair, plus direct exercise selection, progressive enhancement, exact-current-revision home coverage, input options, per-exercise history, and feedback boundaries.
- [ ] It explains that each repertoire level is relative to the included arrangement; source links identify specific public-domain manuscripts; no third-party score, MIDI, recording, engraving, or editorial fingering is bundled; and completion proves only the encoded eight-note pitch order rather than original rhythm, omitted voices, interpretation, or complete-work mastery.
...
- [ ] It explains that a corrected or off-time current completion may offer one page-local repeat, that clean completions do not, that timed repeats retain the selected tempo without starting pulse automatically, and that the independent next-study suggestion remains unchanged.
- [ ] It explains that enhanced home filters use every matching curriculum-track prefix plus hand and untimed/pulse-guided evaluation mode, remain transient and inclusive, default to the complete folio on reload, and change no history, evidence, or recommendation behavior.
...
- [ ] It states the exact catalog split: seventeen right-hand and sixteen left-hand studies, fifteen untimed and eighteen timed. The original thirty foundations remain fifteen per hand and twelve untimed; the timed set contains ten steady-pulse, six regular eighth-grid, and two offbeat studies, while the latter eight retain fractional onset positions and a ±0.1-beat window. Fourteen timed studies use 4/4 with four count-in beats, the 3/4 pair uses three, and the 5/4 pair uses five.
- [ ] It explains the complete event distribution: twenty-two five-event studies, two six-event 5/4 studies, two seven-event 3/4 studies, and seven eight-event studies. Of the timed set, the ten five-event studies have four assessed MIDI-relative intervals, the 5/4 pair has five, the 3/4 pair has six, and the four original eight-event timed studies—the mixed-pattern and steady broken-chord pairs—have seven; the three repertoire arrangements are untimed.
...
- The fifteen untimed exercises must remain distinct from the eighteen timed exercises; none may be described as percentage-scored, AI-evaluated, or cloud-backed.
...
- Immediate repeat guidance must remain distinct from retained newest-five evidence and from the completion/recency study recommender.
...
- Then: they understand the thirty-three exercises available now, including the sourced Beethoven, Bach, and Pachelbel learning arrangements, C-major and D-minor ordered but non-simultaneous chord-tone pairs, D-E-F-G-A five-note ascent pair, D-A keyboard transfer, eight-event steady broken-chord pair, seven-event 3/4 broken-chord pair, six-event 5/4 pulse pair, onset-only repeated-note pair, eight-event mixed-pattern pair, and MIDI-relative offbeat pair, how the expanded but bounded staff pitch guide, transient reading focus, current-attempt repeat cue, timing-derived meter guidance, quarter-pulse and fractional-position onset timing, selection, input, and newest-five factual per-exercise history work, and what the application cannot assess
