...
- [ ] It describes all twelve right- and left-hand exercises, including the two straight and two step-and-skip steady-quarter studies plus the even-eighth pair, direct exercise selection, progressive enhancement, input options, per-exercise history, and feedback boundaries.
...
- The six untimed exercises must remain distinct from the six timed exercises; none may be described as percentage-scored, AI-evaluated, or cloud-backed.
...
- Then: they understand the twelve exercises available now, how the staff pitch guide, quarter-pulse and even-eighth onset timing, selection, input, and per-exercise history work, and what the application cannot assess
