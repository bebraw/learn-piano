...
function collectPageElements(
  ...
  return {
    ...
    historyEvidenceWindow: requireElement(pageDocument, "history-evidence-window", HTMLElement),
    historyPitchEvidence: requireElement(pageDocument, "history-pitch-evidence", HTMLElement),
    historyTimingEvidenceRow: requireElement(pageDocument, "history-timing-evidence-row", HTMLElement),
    historyTimingEvidence: requireElement(pageDocument, "history-timing-evidence", HTMLElement),
